...
/// Writes the downloaded installer to the temp dir, starts it, and quits so it can replace us.
#[tauri::command]
pub fn run_installer(app: AppHandle, name: String, bytes: Vec<u8>) -> Result<String, String> {
