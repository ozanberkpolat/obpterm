...
export const ACTIONS: KeyAction[] = [
  ...
  { id: "agents", label: "Agents (list or nodes)", def: "Ctrl+KeyG", run: (a) => (a.deck.isOpen || a.nodes.isOpen ? (a.deck.close(), a.nodes.close()) : a.openAgents()) },
  { id: "agents-view", label: "Switch agents view (list / nodes)", def: "Ctrl+KeyM", run: (a) => a.toggleAgentsView() },
