...
export const KEYMAP: Binding[] = [
  ...
  { id: "recent", label: "Back to the tab you were just in", keys: ["Ctrl", "Tab"] },
  { id: "cycle", label: "Previous tab in the rail", keys: ["Ctrl", "Shift", "Tab"] },
  { id: "move", label: "Move this tab up / down the rail", keys: ["Ctrl", "Shift", "↑ ↓"] },
